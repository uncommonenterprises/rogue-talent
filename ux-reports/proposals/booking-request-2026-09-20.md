...
---
Status: APPROVED
Note: APPROVED by Neil via decision-card 2026-09-20 — "Approve all defects" + "Approve all three [polish]". (Dead-end CTA / 'verify your email' nudge approved as polish; granting rt-client-02 transaction rights = Neil's test-data action.) Implemented: 1c38357c1 2026-09-20 → DEPLOY-VERIFIED live 2026-09-20 — NoAccessPage(initiate-transactions) now shows a verify-your-email hint + Account settings link.
...
---
Status: APPROVED
Note: APPROVED by Neil via decision-card 2026-09-20 — "Approve all defects" + "Approve all three [polish]". DISPOSITION 2026-09-20: NOT a bug (Developer-confirmed) — Sharetribe inclusive end-date; 27→28 = 2 full days = correct pricing. Clarification note added near date picker. Implemented: dd63b7d77 2026-09-20 (shipped; live note-render not separately checked — minor conditional string, low risk).
...
---
Status: APPROVED
Note: APPROVED by Neil via decision-card 2026-09-20 — "Approve all defects" + "Approve all three [polish]". Implemented: 1ad5c2321 2026-09-20 → DEPLOY-VERIFIED live 2026-09-20 — OrderBreakdown fee note now states model keeps 100%.
...
---
Status: APPROVED
Note: APPROVED by Neil via decision-card 2026-09-20 — "Approve all defects" + "Approve all three [polish]". Implemented: 0778e70dd 2026-09-20 → DEPLOY-VERIFIED live 2026-09-20 — customer order view uses client-facing browser title.
