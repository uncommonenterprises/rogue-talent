...
export const listingTypes = [
  {
    ...
    transactionFields: [
      ...
      // Contracts (v1): there are NO per-booking usage-rights fields. One
      // standard, broad + perpetual Content Licence & Model Release applies to
      // EVERY booking (Neil, 2026-09-21). The client accepts it via the checkout
      // clickwrap (freezes `licenceAgreedByCustomer` + `licenceAgreementVersion`
      // onto tx protectedData); the model agrees by accepting the booking. No
      // duration / channels / territory selection is captured. See
      // src/util/contracts.js + docs/legal/rogue-talent-content-licence-DRAFT.md.
    ],
  },
];
